...
export const ServiceAreaSix = () => {
  ...
  //         <path
  //           opacity="0.4"
  //           d="M67.9492 8.44141H49.3555V6.39062C49.3555 2.99809 46.5957 0.238281 43.2031 0.238281H26.7969C23.4043 0.238281 20.6445 2.99809 20.6445 6.39062V8.44141H2.05078C0.918203 8.44141 0 9.35934 0 10.4922V22.7969C0 26.1947 2.75447 28.9492 6.15234 28.9492H63.8477C67.2455 28.9492 70 26.1947 70 22.7969V10.4922C70 9.35934 69.0818 8.44141 67.9492 8.44141ZM45.2539 8.44141H24.7461V6.39062C24.7461 5.25914 25.6673 4.33984 26.7969 4.33984H43.2031C44.3327 4.33984 45.2539 5.25914 45.2539 6.39062V8.44141Z"
  //           fill="#20282D"
  //         />
  //         <path
  //           d="M37.0508 33.0508H32.9492C32.9492 34.1823 33.8704 35.1016 35 35.1016C36.1296 35.1016 37.0508 34.1823 37.0508 33.0508Z"
  //           fill="#D8DDE0"
  //         />
  //         <path
  //           d="M28.8477 33.0508H6.15234C5.44988 33.0508 4.76451 32.9784 4.10156 32.8432V55.6094C4.10156 59.0019 6.86137 61.7617 10.2539 61.7617H59.7461C63.1386 61.7617 65.8984 59.0019 65.8984 55.6094V32.8432C65.2355 32.9784 64.5501 33.0508 63.8477 33.0508H41.1523C41.1523 36.4433 38.3925 39.2031 35 39.2031C31.6075 39.2031 28.8477 36.4433 28.8477 33.0508ZM37.0508 51.7524L44.4047 44.3984H41.1523C40.0188 44.3984 39.1016 43.4812 39.1016 42.3476C39.1016 41.2141 40.0188 40.2969 41.1523 40.2969H49.3555C50.489 40.2969 51.4062 41.2141 51.4062 42.3476V50.5508C51.4062 51.6843 50.489 52.6016 49.3555 52.6016C48.2219 52.6016 47.3047 51.6843 47.3047 50.5508V47.2984L38.5007 56.1024C37.6996 56.9034 36.4019 56.9035 35.6007 56.1024L28.8477 49.3491L22.0944 56.1024C21.2934 56.9034 19.9955 56.9034 19.1945 56.1024C18.3935 55.3013 18.3935 54.0035 19.1945 53.2024L27.3976 44.9993C28.1987 44.1983 29.4965 44.1983 30.2976 44.9993L37.0508 51.7524Z"
  //           fill="#20282D"
  //         />
  //       </svg>
  //     ),
  ...
  //         />
  //         <path
  //           d="M48.0048 30.4659L47.3038 30.1153V37.0508C47.3038 37.3062 47.2587 37.5493 47.2285 37.7963L51.4054 39.8847V35.9674C51.4054 33.6221 50.1037 31.5153 48.0048 30.4659Z"
  //           fill="#20282D"
  //         />
  //         <path
  //           opacity="0.4"
  ...
  //         />
  //         <path
  //           d="M21.9944 30.4659C19.8954 31.5153 18.5938 33.6221 18.5938 35.9673V39.8845L22.7706 37.7962C22.7404 37.5493 22.6953 37.3062 22.6953 37.0508V30.1153L21.9944 30.4659Z"
  //           fill="#20282D"
  //         />
  //         <path
  ...
  //         <path
  //           opacity="0.4"
  //           d="M36.2097 2.58399C35.4888 2.0553 34.5114 2.0553 33.7904 2.58399C31.6874 4.12207 26.7969 9.09891 26.7969 18.5938V37.0508C26.7969 38.1843 27.7141 39.1016 28.8477 39.1016H41.1523C42.2859 39.1016 43.2031 38.1843 43.2031 37.0508V18.5938C43.2031 9.09891 38.3126 4.12207 36.2097 2.58399ZM35 18.5938C33.8674 18.5938 32.9492 17.6756 32.9492 16.543C32.9492 15.4101 33.8674 14.4922 35 14.4922C36.1326 14.4922 37.0508 15.4101 37.0508 16.543C37.0508 17.6756 36.1326 18.5938 35 18.5938Z"
  //           fill="#20282D"
  //         />
  //       </svg>
  //     ),
      ...
      <div className="row justify-content-center">
        ...
        <div className="col-lg-6">
          <div className={`td-service-6-item mb-60`}>
            <div className="td-service-6-icon">
              <span>
                <img src={icon1} alt="icon" width="70" height="70" />
              </span>
            </div>
        ...
        <div className="col-lg-6">
          <div className={`td-service-6-item mb-60`}>
            <div className="td-service-6-icon">
              <span>
                <img src={icon2} alt="icon" width="70" height="70" />
              </span>
            </div>
            <div className="td-service-6-content">
              <h3 className="td-service-6-title mb-25">
        ...
        <div className="col-lg-6 mx-auto">
          <div className={`td-service-6-item mb-60`}>
            <div className="td-service-6-icon">
              <span>
                <img src={icon3} alt="icon" width="70" height="70" />
              </span>
            </div>
            <div className="td-service-6-content">
              <h3 className="td-service-6-title mb-25">
