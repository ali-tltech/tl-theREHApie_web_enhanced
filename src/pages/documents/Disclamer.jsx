...
export const Disclaimer = () => {
  ...
  useEffect(() => {
    async function fetchSeo() {
      try {
        const response = await seo("disclaimer")
        ...
        <div className="card border-0 shadow-sm">
          <div className="card-header bg-white border-bottom py-4">
            <div className="d-flex-col align-items-center justify-content-between">
              <h1 className="td-document-title-new mb-0 text-dark">Disclaimer</h1>
          ...
          <div className="card-body">
            ...
            <section className="mb-4">
              <h2 className="h4 mb-3 text-dark">1. No Medical Advice</h2>
            ...
            <section className="mb-4">
              <h2 className="h4 mb-3 text-dark">2. Accuracy of Information</h2>
            ...
            <section className="mb-4">
              <h2 className="h4 mb-3 text-dark">3. External Links & Third-Party Content</h2>
              <div className="card border-light">
                <div className="card-body">
            ...
            <section className="mb-4">
              <h2 className="h4 mb-3 text-dark">4. Product & Service Liability</h2>
              <div className="card border-light">
                <div className="card-body">
                  <ul className="text-secondary">
            ...
            <section className="mb-4">
              <h2 className="h4 mb-3 text-dark">5. Limitation of Liability</h2>
              <div className="card border-light">
                <div className="card-body">
                  <ul className="text-secondary">
            ...
            <section className="mb-4">
              <h2 className="h4 mb-3 text-dark">6. Professional & Business Decisions</h2>
              <div className="card border-light">
                <div className="card-body">
                  <ul className="text-secondary">
            ...
            <section className="mb-4">
              <h2 className="h4 mb-3 text-dark">7. Changes to This Disclaimer</h2>
              <div className="card border-light">
                <div className="card-body">
                  <p className="text-secondary">
                    <strong>theREHApie Consultants</strong> reserves the right to modify this disclaimer at any time without prior notice. Your continued use of the website constitutes acceptance of any changes.
                  </p>
                </div>
              </div>
            </section>
